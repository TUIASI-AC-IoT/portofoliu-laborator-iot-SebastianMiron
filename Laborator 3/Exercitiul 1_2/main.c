...
#define CONFIG_EXAMPLE_FIRMWARE_UPGRADE_URL "https://192.168.245.238:5000/firmware.bin" 
#define CONFIG_EXAMPLE_VERSION_CHECK_URL "https://192.168.245.238:5000/version"
...
// esp_err_t _http_event_handler_for_version(esp_http_client_event_t *evt)
// {
...
static void ota_task(void *pvParameters)
{
    ...
    esp_http_client_config_t config_version = {
        .url = CONFIG_EXAMPLE_VERSION_CHECK_URL,
        .cert_pem = (char *)server_cert_pem_start,
        .cert_len = 1422,
        .event_handler = _http_event_handler,
        .keep_alive_enable = true,
    ...
    ESP_LOGI(TAG, "Attempting to read version from %s", config_version.url);
    //ESP_LOGI(TAG, _http_event_handler.evt->user_data);
